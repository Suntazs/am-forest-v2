        ...
        <div className="px-6 md:px-12 lg:px-20">
          <div className="max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-neutral-700 leading-relaxed mb-6">
              Mēs esam uzticams partneris meža īpašumu iegādē. Piedāvājam godīgas cenas, 
              ātru darījumu norisi un profesionālu konsultāciju. Mūsu pieredzējušie eksperti 
              nodrošina caurskatāmu procesu no sākotnējās apsekošanas līdz darījuma noslēgšanai.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="relative z-10 flex items-center justify-center h-full px-6 md:px-12">
          <div className="max-w-2xl text-center">
            ...
            <p className="text-base md:text-lg text-[#faf6ed]/90 leading-relaxed mb-4">
              Mēs esam uzticams partneris meža īpašumu iegādē. Piedāvājam godīgas cenas, 
              ātru darījumu norisi un profesionālu konsultāciju.
            </p>
            <p className="text-base md:text-lg text-[#faf6ed]/90 leading-relaxed mb-8">
              Garantējam konfidencialitāti un individuālu pieeju katram klientam.
            </p>
            <button 
